...
func removeDuplicates1(_ nums: inout [Int]) -> Int {
    var set = Set<Int>()
    for v in nums {
        if set.contains(v), let i = nums.firstIndex(of: v) {
            nums.remove(at: i)
        } else {
            set.insert(v)
        }
...
var arr21 = [1,1,2]
removeDuplicates2(&arr21)
var arr22 = [0,0,1,1,1,2,2,3,3,4]
removeDuplicates2(&arr22)
...
var arr31 = [1,1,2]
removeDuplicates2(&arr31)
var arr32 = [0,0,1,1,1,2,2,3,3,4]
removeDuplicates2(&arr32)
